...
# I don't how I changes the numbers to "homicides"
```
...
```{r Renaming_columns_again}
names(Western_Europe)[4] <- "Homicides"
# I also did this above so I could knit my document
```
...
```{r}
# We don't get this. The facet already has two columns and three rows 
```
